...
0: {imgfile: "",
	...
	EXAud1: {ENG: "Mother is cooking in the kitchen.", ITA: "La mamma sta cucinando in cucina.", JPN: "母は現在台所で料理をしています。",},
	EXAud2: {ENG: "At the end of the corridor there is the bathroom and the kitchen.", ITA: "In fondo al corridoio c'è il bagno e la cucina.", JPN: "廊下の突き当りにお手洗いと台所があります。",},
	EXAud3: {ENG: "The kitchen was very big.", ITA: "La cucina era molto grande.", JPN: "台所はとても大きかった。",},
...
1: {imgfile: "",
	...
	LnContPosLeft: "3%", LnContPosTop: "7%",
	...
	EXAud1: {ENG: "Dry your face with a towel.", ITA: "Asciugati la faccia con un asciugamano.", JPN: "タオルで顔をふきなさい。",},
	EXAud2: {ENG: "Could you bring me a towel?", ITA: "Mi potresti portare un asciugamano?", JPN: "タオルを持て来てくれますか。",},
	EXAud3: {ENG: "This towel is too small.", ITA: "Questo asciugamano è troppo piccolo.", JPN: "このタオルは小さすぎます。",},
...
2: {imgfile: "",
	...
	LnContPosLeft: "19%", LnContPosTop: "8%",
	...
	EXAud1: {ENG: "Put the dishes in the cupboard.", ITA: "Metti i piatti nella credenza.", JPN: "お皿を戸棚に",},
	EXAud2: { ENG: "The cupboard is nEXAudt to the refridgerator.", ITA: "La credenza è accanto al frigorifero.", JPN: "戸棚は冷蔵庫の隣です。",},
	EXAud3: {ENG: "The cupboard is full of dishes.", ITA: "La credenza è piena di stoviglie.", JPN: "戸棚はお皿でいっぱい",},
...
3: {imgfile: "",
	...
	LnContPosLeft: "14%", LnContPosTop: "43%",
	BtnPosLeft: "9%", BtnPosTop: "0%",
	LnPosX1: "75%", LnPosY1: "25%",
	LnPosX2: "45%", LnPosY2: "55%",
	...
	EXAud1: {ENG: "How can I unblock the kitchen drain?", ITA: "Come posso sbloccare lo scarico della cucina?", JPN: "台所の排水口のブロックを解除するにはどうすればよいですか？",},
	EXAud2: {ENG: "The ring went inside the basin drain.", ITA: "l'anello è andato dentro lo scarico<span> del lavandino.", JPN: "リングは、流域の排水口の内に入りました。",},
	EXAud3: {ENG: "We have to wash the basin drain.", ITA: "Dobbiamo pulire lo scarico del lavandino.", JPN: "排水口洗わないとだめです。",},
...
4: {imgfile: "",
	...
	LnContPosLeft: "43%", LnContPosTop: "15%",
	BtnPosLeft: "4.5%", BtnPosTop: "0%",
	LnPosX1: "50%", LnPosY1: "25%",
	LnPosX2: "50%", LnPosY2: "65%",
	...
	EXAud1: {ENG: "You can't use this tap. It's out of order.", ITA: "Non puoi usare questo rubinetto; è fuori uso.", JPN: "この蛇口は使えません。故障しています。",},
	EXAud2: {ENG: "We don't drink the water from the tap", ITA: "Non beviamo acqua dal rubinetto.", JPN: "私たちは蛇口からの水を飲みません。",},
	EXAud3: {ENG: "Don't forget to close the tap.", ITA: "Non dimenticare di chiudere il rubinetto.", JPN: "蛇口を閉めることを忘れないでください。",},
...
5: {imgfile: "",
	...
	LnContPosLeft: "53%", LnContPosTop: "3%",
	BtnPosLeft: "4.5%", BtnPosTop: "0%",
	LnPosX1: "50%", LnPosY1: "25%",
	LnPosX2: "50%", LnPosY2: "65%",
	...
	EXAud1: {ENG: "I'm going to buy the dish washing liquid.", ITA: "Vado a comprare il detersivo per i piatti.", JPN: "洗剤を買いに行く。",},
	EXAud2: {ENG: "Use the new dish washing liquid and clean the wine glasses.", ITA: "Usa il nuovo　detersivo e　lava i bicchieri da vino.", JPN: "新しい洗剤を使ってワイングラスを洗って。",},
	EXAud3: {ENG: "The dish washing liquid is about to run out.", ITA: "Il detersivo per piatti sta per finire.", JPN: "洗剤がなくなりそうです。",},
...
6: {imgfile: "",
	...
	LnContPosLeft: "57%", LnContPosTop: "37%",
	...
	EXAud1: {ENG: "I saw the sponge in the sink.", ITA: "Ho visto la spugna nel lavandino.", JPN: "スポンジは流しに見た。",},
	EXAud2: {ENG: "The sponge for washing the dishes is dirty.", ITA: "La spugna per lavare i piatti　è　sporca. ", JPN: "お皿を洗うためのスポンジは汚い。",},
	EXAud3: {ENG: "Don't use that sponge to wash the car.", ITA: "Non usare quella spugna per lavare la macchina.", JPN: "あのスポンジを車を洗うために使わないで。",},
...
7: {imgfile: "",
	...
	LnContPosLeft: "40%", LnContPosTop: "44%",
	BtnPosLeft: "4.5%", BtnPosTop: "0%",
	LnPosX1: "50%", LnPosY1: "25%",
	LnPosX2: "50%", LnPosY2: "54%",
	...
	EXAud1: {ENG: "Put the plate in the sink.", ITA: "Metti il piatto nel lavandino.", JPN: "お皿を流しに入れて。",},
	EXAud2: {ENG: "The toilet paper is under the sink.", ITA: "La carta igienica è sotto il lavandino.", JPN: "トイレットペーパーは、流しの下にあります。",},
	EXAud3: {ENG: "Can you fix my sink?", ITA: "Puoi aggiustarmi il lavandino?", JPN: "流しを直してくれえる？",},
...
8: {imgfile: "",
	...
	LnContPosLeft: "72%", LnContPosTop: "5%",
	BtnPosLeft: "4.5%", BtnPosTop: "0%",
	LnPosX1: "50%", LnPosY1: "25%",
	LnPosX2: "50%", LnPosY2: "65%",
	...
	EXAud1: {ENG: "The microwave is there.", ITA: "Il forno a microonde è lì.", JPN: "電子レンジはあっちだ。",},
	EXAud2: {ENG: "Reheat the tea in the microwave.", ITA: "Riscalda il tè nel forno a microonde.", JPN: "電子レンジでお茶を温める。",},
	EXAud3: {ENG: "Don't put metal in the microwave.", ITA: "Non mettere metallo nel forno a microonde.", JPN: "電子レンジの中に金属を入れないで。",},
