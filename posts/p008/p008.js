...
0: {imgfile: "",
	...
	EXAud1: {ENG: "Planets move around a fixed star.", ITA: "I pianeti ruotano attorno ad una stella fissa.", JPN: "惑星は恒星の周りを回る。",},
	EXAud2: {ENG: "I live on this planet.", ITA: "Vivo su questo pianeta.", JPN: "私はこの惑星に住んでいる。",},
	EXAud3: {ENG: "The Earth, Mars and Jupiter are planets.", ITA: "La Terra, Marte e Giove sono pianeti.", JPN: "地球や火星、木星は惑星である。",},
...
1: {imgfile: "",
	...
	EXAud1: {ENG: "The planet closet to the sun is Mercury.", ITA: "Il pianeta più vicino al sole è Mercurio.", JPN: "太陽に一番近い惑星は水星である。",},
	EXAud2: {ENG: "Mercury is a rocky planet.", ITA: "Mercurio è un pianeta roccioso.", JPN: "水星は岩だらけの惑星です。",},
	EXAud3: {ENG: "Mercury does not have moons.", ITA: "Mercurio non possiede satelliti.", JPN: "水星には月がありません。",},
...
2: {imgfile: "",
	...
	EXAud1: {ENG: "Venus is the second planet of the solar system.", ITA: "Venere è il secondo pianeta del Sistema solare.", JPN: "金星は、太陽系で2番目の惑星。",},
	EXAud2: {ENG: "Venus has much more carbon dioxide than the Earth.", ITA: "Venere è molto più ricca di anidride carbonica rispetto a la terra.", JPN: "金星は地球よりもはるかに多くの二酸化炭素を持っています。",},
	EXAud3: {ENG: "Venus is the most luminous planet in the sky.", ITA: "Venere è il pianeta più luminoso nel cielo.", JPN: "金星は空で最も明るい惑星です。",},
...
3: {imgfile: "",
	...
	EXAud1: {ENG: "The Earth is the second planet of the solar system.", ITA: "La Terra è il terzo pianeta del sistema solare.", JPN: "地球は、太陽系で3番目の惑星。",},
	EXAud2: {ENG: "The Earth is round.", ITA: "La Terra è rotonda.", JPN: "地球は丸い。",},
	EXAud3: {ENG: "The Earth formed 4.5 billion years ago.", ITA: "la Terra si è formata 4,5 miliardi di anni fa.", JPN: "地球は45億年前に形成されました。",},
...
4: {imgfile: "",
	...
	EXAud1: {ENG: "Mars is the fourth planet of the solar system.", ITA: "Marte è il quarto pianeta del Sistema solare.", JPN: "火星は、太陽系で４番目の惑星。",},
	EXAud2: {ENG: "Mars has two moons.", ITA: "Marte ha due lune.", JPN: "火星は二つ衛星がある。",},
	EXAud3: {ENG: "Is there any life on Mars?", ITA: "C'è vita su Marte?", JPN: "火星に生命はありますか？",},
...
5: {imgfile: "",
	...
	EXAud1: {ENG: "Jupiter is the fifth planet of the solar system.", ITA: "Giove è il quinto pianeta del Sistema solare.", JPN: "火星は、太陽系で５番目の惑星。",},
	EXAud2: {ENG: "Jupiter is the biggest planet of the solar system.", ITA: "Giove è il pianeta più grande del Sistema solare.", JPN: "木星は太陽系の最大の惑星です。",},
	EXAud3: {ENG: "Jupiter, like Saturn, Uranus, and Neptune is a gas planet.", ITA: "Giove, come Saturno, Urano e Nettuno, è un pianeta gassoso.", JPN: "木星は、土星、天王星、海王星のようなガス惑星です。",},
...
6: {imgfile: "",
	...
	EXAud1: {ENG: "Saturn is the sixth planet of the solar system.", ITA: "Saturno è il sesto pianeta del sistema solare.", JPN: "土星は、太陽系で６番目の惑星。",},
	EXAud2: {ENG: "Saturn is the second largest planet after Jupiter in the solar system.", ITA: "Saturno è il secondo pianeta per grandezza dopo Giove nel sistema solare.", JPN: "土星は、太陽系で木星に次いで2番目に大きい惑星です。",},
	EXAud3: {ENG: "The rings of Saturn are made from billions of small objects.", ITA: "Gli anelli di Saturno sono composti da miliardi di piccoli oggetti.", JPN: "土星の輪は、数十億の小さな物体からできています。",},
...
7: {imgfile: "",
	...
	EXAud1: {ENG: "Uranus is the seventh planet of the solar system.", ITA: "Urano è il settimo pianeta del sistema solare.", JPN: "天皇制は、太陽系で７番目の惑星。",},
	EXAud2: {ENG: "Uranus was discovered by acccident in 1781 by William Herschel.", ITA: "Urano venne scoperto casualmente al telescopio da William Herschel, nel 1781", JPN: "天王星は、ウィリアム・ハーシェルによって1781年に事故によって発見されました。",},
	EXAud3: {ENG: "There are many small moons that rotate around Uranus.", ITA: "Ci sono tante piccole lune che ruotano intorno a Urano.", JPN: "天王星の周りを回転する多くの小さな月があります。",},
...
8: {imgfile: "",
	...
	EXAud1: {ENG: "Neptune is the eight planet of the solar system.", ITA: "Nettuno è il ottavo pianeta del sistema solare.", JPN: "海王星は、太陽系で８番目の惑星。",},
	EXAud2: {ENG: "Neptune is the fourth largest planet of the solar system.", ITA: "Nettuno è il quarto pianeta più grande del sistema solare.", JPN: "海王星は、太陽系で4番目に大きな惑星です。",},
	EXAud3: {ENG: "The first observation of Neptune was made in 1612 by Galileo Galilei.", ITA: "La prima osservazione di Nettuno fu effettuata da Galileo Galilei nel 1612.", JPN: "海王星の最初の観測は、ガリレオガリレイによって1612年に行われました。",},
