...
function indexpage() {
	...
	if (localStorage.getItem("GlType") == "BW") {
		PstTotl = 11; //Input by me - BW total cards

	}
	if (localStorage.getItem("GlType") == "CLR") {
		PstTotl = 4; //Input by me - CLR total cards

	}
	if (localStorage.getItem("GlType") == "ALL") {
		PstTotl = 15; //Input by me - CLR and BW total cards
	}
...
<div style="border: 1px solid red; display: inline-block; float: left; position: relative; width: 100%; height: 100%;">
	<div style="float: left; border: 1px solid blue; position: relative; height: 100%; display: inline-block;">
	<!-- contains card type elements -->
		<p style="margin-left: 5px; border: 1px solid #000; float: left;">

			<span id="GlCrdTypeTxtId" style="margin-right: 5px; border: 0px solid #000; text-decoration: none;"></span>

			<a id="GlTypeIdBW" href="gallery.html" onClick="SetGlType('BW')" style="display: none;">
			<!-- to be removed -->
			</a>

		</p>
			<a id="GlTypeIdCLR" href="gallery.html" onClick="SetGlType('CLR')" style="display: none;">
			<!-- to be removed -->
			</a>
			...
			<a href="gallery.html" onClick="SetGlType('ALL')" style="text-decoration: none; float: left; border: 1px solid #000; margin-top: 3px;">
			...
			<div style="float: left; border: 1px solid #000;">
				<span id="IndxMdeTxtId" style="margin-left: 10px; margin-right: 5px; border: 0px solid #000; text-decoration: none; float: left;">index mode:</span>

				<a href="gallery.html" onClick="SetIndxMde('LST')" style="text-decoration: none; float: left; ">list</a>
				<span id="FwdSlshId" style="margin-left: 5px; margin-right: 5px; float: left;"> / </span>
				<a href="gallery.html" onClick="SetIndxMde('GAL')" style="text-decoration: none; float: left; ">ga</a>
			</div>
	...
	if (localStorage.getItem("GlType") == "BW") {
		//PstTotl = 11; //Input by me - BW total cards
		document.getElementById("GlBWOptn").className += " GlOpSlct";
	}
	if (localStorage.getItem("GlType") == "CLR") {
		//PstTotl = 4; //Input by me - CLR total cards
		document.getElementById("GlCLROptn").className += " GlOpSlct";
	}
	if (localStorage.getItem("GlType") == "ALL") {
		//PstTotl = 15; //Input by me - CLR total cards
		document.getElementById("GlALLOptn").className += " GlOpSlct";
...
function PMuis() {
	...
	<div class="" style="background-color: #fff; width: 100%; height: 100px; border-top: 1px solid #808080; margin-top: 10px;">
		...
		<a href="post.html" onClick="SetPstId('${pno}')" id="${PstLnkTxtId}" style="float: right; padding-top: 0px; margin-top: 0px;">
			${pTtl}
		</a>
	</div>
	`;
...
function PImgs() {
	...
	var PNavItmX = [];
    PNavItmX[i] = pnavexp;
	document.getElementById("GalCnt").insertAdjacentHTML("beforeend", PNavItmX[i]);
...
function GalTypeLoader(L1) {
	...
	//alert(L1);
	//document.getElementById("GlTypeIdCLR").innerHTML = UItext[L1]["CrdTCLRTxt"];

	//document.getElementById("GlTypeIdBW").innerHTML = UItext[L1]["CrdTBWTxt"];
	...
	if (GlType == "BW") {
		//document.getElementById("GlTypeIdBW").className = "GlTypeHlight";
		//document.getElementById("GlTypeIdCLR").className = "GlTypeOff";
	} else {
		//document.getElementById("GlTypeIdBW").className = "GlTypeOff";
		//document.getElementById("GlTypeIdCLR").className = "GlTypeHlight";
	}
}
