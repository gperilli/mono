...
CarPstTtl = 9; //Input by me //Should be 5 or greater in order to fill DSP function
...
function landerpage() {
	...
	MonoDemo = `
		<div id="MnoDemoCnt">
		<p id="DemoTxt" style="width: 100%; margin-bottom: 10px; float: left; border: 0px solid #808080;" align="center">Demo</p>
			<div id="MonoDemo">
	...
	ClToActBx = `
		...
		<div style="width: 100%; background-color: #fff; border: 0px solid red; display: inline-block; position: relative; box-sizing: border-box; padding-bottom: 5px; padding-top: 20px;" align="center">
		...
		<!-- Call To Action -->	
		<div style="float: left; display: inline-block; position: relative; padding-top: 20px; padding-bottom: 20px; border: 0px solid blue; width: 100%;">
			<div class="CTACnt">		
				<div align="center">
		...
		<div class="">
			...
			<div class="colL2In">
				...
				<div class="colL2In2" style="border: 0px solid red;" id="LSlctBlk">
					<p id="LSelectTxt" style="width: 100%; margin-bottom: 10px; float: left; border: 0px solid #808080;" align="center">Language Select</p>
	...
	document.getElementById("TemplateContainer").insertAdjacentHTML("beforeend", centralcolumnhead);
		...
		document.getElementById("CentralColumn").insertAdjacentHTML("beforeend", LanderTemp);
			...
			document.getElementById("MnoDemoCnt").insertAdjacentHTML("beforeend", PstLnk);
...
function CTADspPsts(j) {
	...
	if (DsppId.AnnotType == "Annot") {
		...
		//var DspPstImgASrcX = "p".concat(RndPstArr[LdN], "/monop", RndPstArr[LdN], "-wi0a.svg");
	} else {
		var DspPstImgSrcX = "p".concat(RndPstArr[LdN], "/monop", RndPstArr[LdN], "-wi0.svg");
	}
	...
	for(var i = 1; i < 9; ++i) {
		...
		CTADspPrt2 = CTAPstImgHd.concat(BtnTemp1, BtnTemp2, BtnTemp3, BtnTemp4, BtnTemp5, BtnTemp6, BtnTemp7, BtnTemp8, CTAPstImgTl);
	...
	//CTADspItmX = "CTADspItm".concat(LdN);
	...
	//var CTADsp = CTADspPrt1.concat(CTADspPrt2, CTADspPrt3);
...
function CTAItmDsp() {
	...
	document.getElementById(CTADspItmBlkX).className = "CTADspItmShw ".concat(CrdAgleCls);
			...
			for(var j = 1; j < 9; ++j) {
				...
				<svg class="buttonL" id=${BtnContainerP00XBtnIDX} x="0%" y="12%" width="9%" height="12%">
				  <g transform="scale(1, 1)">
					...
					<svg class="${pno}T btnToff" id=${P00XBtnImgIdXT} onClick="MUIUpdP00X('${pno}', ${i}, 'BtnClk')">
						<g>
							<circle cx="51%" cy="50%" r="20%"/>
							Sorry, your browser does not support inline SVG.
						</g>
